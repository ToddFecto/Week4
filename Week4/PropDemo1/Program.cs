...
namespace PropDemo1
{
    class Rectangle
    {
        ...
        // Add the same for pHeight - SEE BELOW:
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //r1.SetWidth(20);
            //Console.WriteLine(r1.GetWidth()); // Exptecting to see a 20

            // Programmers really like to do something like this:
            // We can use the getter and setter by using syntax that looks like
            //we're just raeding and writing a member variable. But we aren't.
            // W're actually calling the getter and setter functions.
            r1.Width = -5;
            Console.WriteLine(r1.Width); // Expecting to see a 0
            r1.Width = 20;
            Console.WriteLine(r1.Width); // Exptecting to see a 20
            r1.Height = 30;
            Console.WriteLine(r1.Height); //Exptecting to see a 30
            r1.Length = 50;
            Console.WriteLine(r1.Length); //Exptecting to see a 50
        }
    }
}
