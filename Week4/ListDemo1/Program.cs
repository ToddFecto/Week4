...
namespace ListDemo1
{
    class Person
    {
        ...
        {
            // Demo on how to guard against bad data
            if (_Name == "")
            {
                _Name = "EMPTY";
            }
        ...
        public override string ToString()  //Just a function that returns a string
        {
            return $"{pName}, {pEmail}";
        }
    }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(p2.GetName());  // Expect Sally Smith on the console
            p2.SetEmail("sally@rocket.com");
            Console.WriteLine(p2.GetEmail()); //Expect sally@rocket.com

            Person p3 = new Person();
            p3.SetName("Julie Jones");
            Console.WriteLine(p3.GetName());  // Expect Julie Jones on the console
            ...
            // Try chaging members of the list items
            ...
            foreach (Person check in people)
            {
                ...
                {
                    //Console.WriteLine(check.GetEmail()); // For tetsting: Expect to see sally@rocket.com
                    found = check;
