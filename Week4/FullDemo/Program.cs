...
namespace FullDemo
{
    class Cake
    {
        ...
        private string pFrosting;

        // Here are the constructors. We have two: The default and the one that takes all members
        public Cake()
        {
        ...
        public Cake(string _Kind, int _Layers, string _Flavor, string _Frosting)
        {
            ...
            // let's call our setter fucntions. When we're inside a member function
            // we don't need to specify an object (eg. c1.SetKind
            SetKind(_Kind);
            SetLayers(_Layers);
            SetFlavor(_Flavor);
    ...
    class Program
    {
        ...
        {
            // Test code
            // We're commenting it out, but keeping it in case we need it later.
            //Cake c1 = new Cake();
            ...
            //Cake c3 = new Cake("Shortbread", 0, "Vanilla", "Strawberry");
            ...
            if (mycake != null)
            {
                ...
                Console.WriteLine("Found the cake!");
                Console.WriteLine(mycake);
            }
            else
            {
